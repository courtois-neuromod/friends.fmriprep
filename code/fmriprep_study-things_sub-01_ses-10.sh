...
#SBATCH --output=/lustre04/scratch/bpinsard/cneuromod.things.fmriprep/code/fmriprep_study-things_sub-01_ses-10.out
#SBATCH --error=/lustre04/scratch/bpinsard/cneuromod.things.fmriprep/code/fmriprep_study-things_sub-01_ses-10.err
