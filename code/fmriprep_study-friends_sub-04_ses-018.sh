...
#SBATCH --output=/lustre04/scratch/bpinsard/cneuromod.friends.fmriprep/code/fmriprep_study-friends_sub-04_ses-018.out
#SBATCH --error=/lustre04/scratch/bpinsard/cneuromod.friends.fmriprep/code/fmriprep_study-friends_sub-04_ses-018.err
