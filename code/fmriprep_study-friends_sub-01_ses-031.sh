...
#SBATCH --output=/lustre04/scratch/bpinsard/cneuromod.friends.fmriprep/code/fmriprep_study-friends_sub-01_ses-031.out
#SBATCH --error=/lustre04/scratch/bpinsard/cneuromod.friends.fmriprep/code/fmriprep_study-friends_sub-01_ses-031.err
