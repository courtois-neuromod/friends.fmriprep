...
#SBATCH --job-name=fmriprep_study-friends_sub-02_ses-069.job
#SBATCH --output=/lustre04/scratch/bpinsard/cneuromod.friends.fmriprep/code/fmriprep_study-friends_sub-02_ses-069.out
#SBATCH --error=/lustre04/scratch/bpinsard/cneuromod.friends.fmriprep/code/fmriprep_study-friends_sub-02_ses-069.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-friends_sub-02_ses-069_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-friends_sub-02_ses-069 ; fi 
