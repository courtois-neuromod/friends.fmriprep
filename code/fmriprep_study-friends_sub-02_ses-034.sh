...
flock --verbose /project/rrg-pbellec/ria-beluga/alias/friends.fmriprep/.datalad_lock datalad clone ria+file:///project/rrg-pbellec/ria-beluga/alias/friends.fmriprep $LOCAL_DATASET
cd $LOCAL_DATASET
...
if [ -e $LOCAL_DATASET/resource_monitor.json ] ; then cp $LOCAL_DATASET/resource_monitor.json /scratch/bpinsard/fmriprep_study-friends_sub-02_ses-034_resource_monitor.json ; fi 
