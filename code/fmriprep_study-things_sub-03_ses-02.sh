...
#SBATCH --output=/lustre04/scratch/bpinsard/cneuromod.things.fmriprep/code/fmriprep_study-things_sub-03_ses-02.out
#SBATCH --error=/lustre04/scratch/bpinsard/cneuromod.things.fmriprep/code/fmriprep_study-things_sub-03_ses-02.err
